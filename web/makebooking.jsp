                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 pb-20">
                            <div class="about-description">
                                <h2>Make Booking Page</h2> 
                                <br>
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Booking ID:</div>

                                    <div class="col-md-4  col-xs-8 pb-20"><input type="text" name="bid" class="col-md-8" required></div>
                                </div>
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Item ID:</div>

                                    <div class="col-md-4  col-xs-8 pb-20">
                                        <select name="iid" class="col-xs-10">
                                ...
                                <div class="col-xs-12 pb20">
                                    ...
                                    <div class="col-md-4  col-xs-8 pb-20">
                                        <select name="scid" class="col-xs-10">
                                ...
                                <div class="col-xs-12 pb20">
                                    ...
                                    <div class="col-md-4  col-xs-4 pb-20 col-xs-offset-2">
                                        <button type="submit" class="col-xs-12">Make Booking</button>
                                    </div>
                                </div>
                            </div>  
                        </div>
