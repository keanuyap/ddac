                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-10 col-xs-offset-1 text-center">
                            <h2 class="intro-heading caps">Search Item</h2>

                            <div class="col-sm-4" align="left">Enter Keyword: </div>

                            <div><input type="text" name="Ikeyword" class="col-sm-8"></div>
                            <br><br>
                            <div class="col-sm-4" align="left">Select Categories: </div>

                            <div><select name="ICategories" class="col-md-8">
                        ...
                        <div class="col-md-20 text-center pb-20">
                            ...
                            <div class="col-md-15">
                                <table id="table">
                                    ...
                                    <c:forEach items="${Iresult}" var="iresult">
                                        <tr>
                                            <td class="col-md-1">${iresult.id}</td>
                                            <td class="col-md-2">${iresult.iname}</td>
                                            <td class="col-md-1">${iresult.cid.id}</td>
                                            <td class="col-md-1">${iresult.weight}</td>
                                        </tr>
                                    </c:forEach>
                                </table>
                            </div> 
