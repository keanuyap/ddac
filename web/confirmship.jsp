...
<html>
    ...
    <body>
        <form action ="RegisterSchedule" method="post">
                        ...
                        <div class="col-xs-12 pb-20">
                            <div class="about-description">
                                ...
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Schedule ID:</div>

                                    <div class="col-md-4  col-xs-8 pb-20"><input type="text" name="id" class="col-md-8" required></div>
                                </div>
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Departure:</div>

                                    <div class="col-md-4  col-xs-8 pb-20"><input type="text" name="departure" class="col-md-8" required></div>
                                </div>
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Arrival:</div>

                                    <div class="col-md-4  col-xs-8 pb-20"><input type="text" name="arrival" class="col-md-8" required></div>
                                </div>
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Departure date:</div>

                                    <div class="col-md-4  col-xs-8 pb-20"><% out.println(request.getParameter("ddate"));%><input type="hidden" value="<% out.println(request.getParameter("ddate"));%>" name="ddate" class="col-md-8"></div>
                                </div>
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Arrival Time:</div>

                                    <div class="col-md-4  col-xs-8 pb-20"><% out.println(request.getParameter("adate"));%><input type="hidden" value="<% out.println(request.getParameter("adate"));%>" name="adate" class="col-md-8"></div>
                                </div>
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Ship Available:</div>

                                    <div class="col-md-4  col-xs-8 pb-20">
                                        <select name="sid" class="col-xs-10">
                                ...
                                <div class="col-xs-12 pb20">
                                    ...
                                    <div class="col-md-4  col-xs-4 pb-20 col-xs-offset-2">
                                        <button type="submit" class="col-xs-12">Register Schedule</button>
                                    </div>
                                </div>
                            </div>  
                        </div>
