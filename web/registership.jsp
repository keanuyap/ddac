                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 pb-20">
                            <div class="about-description">
                                <h2>Register Ship Page</h2> 
                                <br>
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Ship id:</div>

                                    <div class="col-md-4  col-xs-8 pb-20"><input type="text" name="id" class="col-md-8" required></div>
                                </div>
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Ship Name:</div>

                                    <div class="col-md-4  col-xs-8 pb-20"><input type="text" name="shipname" class="col-md-8" required></div>
                                </div>
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Capacity (tons):</div>

                                    <div class="col-md-4  col-xs-8 pb-20"><input type="number" name="capacity" class="col-md-8" required></div>
                                </div>
                                <div class="col-xs-12 pb20">
                                ...
                                <div class="col-xs-12 pb20">
                                    ...
                                    <div class="col-md-4  col-xs-4 pb-20 col-xs-offset-2">
                                        <button type="submit" class="col-xs-12">Register Ship</button>
                                    </div>
                                </div>
                            </div>  
                        </div>
