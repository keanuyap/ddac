                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 pb-20">
                            <div class="about-description">
                                ...
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Customer Name:</div>

                                    <div class="col-md-4  col-xs-8 pb-20"><input type="text" name="cname" class="col-md-8" required></div>
                                </div>
                                <div class="col-xs-12 pb20">
                                    <div class="col-md-4  col-xs-4 pb-20">Address:</div>

                                    <div class="col-md-4  col-xs-8 pb-20"><input type="text" name="address" class="col-md-8" required></div>
                                </div>
                                <div class="col-xs-12 pb20">
