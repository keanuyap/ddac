...
<html>
    ...
    <body>
        ...
        <form action ="SearchAgent" method="post">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-10 col-xs-offset-1 text-center">
                            <h2 class="intro-heading caps">Search Agent</h2>

                            <div class="col-sm-4" align="left">Enter Keyword: </div>

                            <div><input type="text" name="Akeyword" class="col-sm-8"></div>
                            <br><br>
                            <div class="col-sm-4" align="left">Select Categories: </div>

                            <div><select name="ACategories" class="col-md-8">
                        ...
                        <div class="col-md-20 text-center pb-20">
                            ...
                            <div class="col-md-15">
                                <table id="table">
                                    ...
                                    <c:forEach items="${Aresult}" var="aresult">
                                        <tr>
                                            <td class="col-md-1">${aresult.id}</td>
                                            <td class="col-md-2">${aresult.fname}</td>
                                            <td class="col-md-1">${aresult.gender}</td>
                                            <td class="col-md-2">${aresult.lname}</td>
                                            <td class="col-md-1 nopadding">${aresult.password}</td>
                                            <td class="col-md-2 nopadding">${aresult.position}</td>
                                            <td class="col-md-2 nopadding">${aresult.status}</td>
                                        </tr>
                                    </c:forEach>
                                </table>
                            </div> 
