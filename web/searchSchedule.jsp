                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-10 col-xs-offset-1 text-center">
                            <h2 class="intro-heading caps">Search Schedule</h2>
                        ...
                        <div class="col-md-20 text-center pb-20">
                            ...
                            <div class="col-md-15">
                                <table id="table">
                                    ...
                                    <c:forEach items="${Scresult}" var="scresult">
                                        <tr>
                                            <td class="col-md-2">${scresult.id}</td>
                                            <td class="col-md-2">${scresult.departure}</td>
                                            <td class="col-md-2">${scresult.arrival}</td>
                                            <td class="col-md-1">${scresult.DDate}</td>
                                            <td class="col-md-1">${scresult.ADate}</td>
                                            <td class="col-md-1">${scresult.sid.id}</td>
                                            <td class="col-md-1">${scresult.acapacity}</td>
                                            <td class="col-md-1">${scresult.status}</td>
                                        </tr>
                                    </c:forEach>
                                </table>
                            </div> 
